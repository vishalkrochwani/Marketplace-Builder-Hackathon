          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <form className="space-y-4">
                ...
                {/* Login Button */}
                <button className="w-full px-14 py-3 bg-transparent border border-black rounded-md text-black text-lg hover:bg-black hover:text-white transition">
                  Login
                </button>
                <Link href="#" className="text-lg text-blue-600 px-8 block text-center">
                  Lost your password?
                </Link>
              </form>
            </div>
            ...
            <div className="space-y-6">
              ...
              <form className="space-y-4">
                {/* Email Address */}
                <div>
                  <label className="block text-lg font-semibold" htmlFor="registerEmail">
                    Email Address
                  </label>
                  <input
                    type="email"
